...
// ── Sample product data ────────────────────────────────────────────────────
const allProducts = [
  { id: 1, name: "Canon Camera EOS 2000, Black 10x zoom", price: 998, oldPrice: 1128, rating: 4.5, orders: 154, shipping: "Free Shipping", verified: true, img: phone2, desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam." },
  ...
  { id: 3, name: "Apple iPad Pro 11-inch Liquid Retina", price: 998, oldPrice: null, rating: 4.8, orders: 154, shipping: "Free Shipping", verified: false, img: Ipad, desc: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident." },
  { id: 4, name: "MacBook Pro 14-inch Laptop - Space Gray", price: 998, oldPrice: 1299, rating: 4.9, orders: 154, shipping: "Free Shipping", verified: true, img: laptop, desc: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo." },
  { id: 5, name: "Smart Watch Series 6 - Silver Aluminum", price: 998, oldPrice: 1128, rating: 4.2, orders: 154, shipping: "Free Shipping", verified: true, img: watch, desc: "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi." },
  { id: 6, name: "Wireless Headphones Premium - White", price: 998, oldPrice: null, rating: 3.8, orders: 154, shipping: "Free Shipping", verified: false, img: headset, desc: "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas." },
];
          ...
          {ratingOptions.map(r => (
            <label key={r} className="flex items-center gap-2 cursor-pointer select-none">
              <input
                ...
                name="rating-list"
                checked={selRating === r}
                onChange={() => { setSelRating(r); setPage(1); }}
                className="accent-blue-600 w-3.5 h-3.5"
              />
              <Stars rating={r} />
            </label>
          ...
          {viewMode === "grid" && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {paginated.map(p => (
                <div
                  key={p.id}
                  className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
                  onClick={() => navigate("/details/1")}
                >
                  <div className="relative mb-3 flex items-center justify-center h-44 bg-gray-50 rounded-lg p-2">
                    <img
                      src={p.img}
                      alt={p.name}
